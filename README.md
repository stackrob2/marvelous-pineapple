...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://localhost.stackbit.com/pull/5ffc1884bc00ee71a9855018
...
To start editing your site, you can use the Sanity interface at https://marvelous-pineapple-c1884.sanity.studio/.
...
Generated at `2021-01-11T09:21:23.161Z` by Stackbit version `0.3.42`.